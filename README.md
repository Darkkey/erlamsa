...
* `probe` -- network probe monitor. This monitor send network "probes" (e.g. UDP packets or TCP connetcions) to the target endpoint and alarms if there is a timeout and/or connection refused happened. Supported options includes:
